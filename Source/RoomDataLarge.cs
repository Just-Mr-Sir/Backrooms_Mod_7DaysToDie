...
namespace BackroomsGenV1_1NET4_5
{
    internal class RoomDataLarge : RoomData
    {
        ...
        public RoomDataLarge(string f, float w, Dictionary<string, float> ow, int sx, int offsetY, int sz, Vector3i[] sp, bool isHead, string[] parts, Vector3i[] partDisplacement) : 
            base(f, w, ow, sx, offsetY, sz, sp)
        {
            this.isHead = isHead;
            this.parts = parts;
